...
const Status = () => {
  return (
    <div class="row" style={{ width: "70%",  marginLeft: 'auto',marginRight: 'auto', marginTop: 50
 }}>
      <div class="center">
        <table class="table table-hover btn-hover color-electric" style={{  borderRadius: 30, border: 'none' }}>
          <thead>
            <tr>
              <th scope="col">#</th>
          ...
          <tbody style={{ background: "white", borderRadius: 30, border: 'none' }}>
